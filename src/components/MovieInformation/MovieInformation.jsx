...
import {
  Movie as MovieIcon, Theaters, Language, PlusOne, Favorite, FavoriteBorderOutlined, Remove, ArrowBack, TroubleshootRounded,
...
function MovieInformation() {
  ...
  const { data: recommandations, isFetching: isRecommandationsFetching } = useGetRecommendationQuery({ list: '/recommendations', movie_id: id });
  ...
  return (
    <Grid container className={classes.containerSpaceAround}>
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.genresContainer}>
          {
            data?.genres?.map((genre) => (
              <Link style={{ textDecoration: 'none' }} key={genre.name} className={classes.links} to="/" onClick={() => dispatch(selectGenreOrCategory(genre.id))}>
                <img
                  src={gernreIcons[genre.name.toLowerCase()]}
        ...
        <Typography variant="h5" gutterBottom styel={{ marginTop: '10px' }}>
          Overview
        </Typography>
        <Typography gutterBottom styel={{ marginButton: '2rem' }}>
          {data?.overview}
        </Typography>
          ...
          <div className={classes.buttonContainer}>
            <Grid item xs={12} sm={6} className={classes.buttonContainer}>
              <ButtonGroup size="medium" variant="outlined">
                ...
                <Button onClick={() => setOpen(TroubleshootRounded)} href="#" endIcon={<Theaters />}>
                  Trailer
                </Button>
              </ButtonGroup>
            ...
            <Grid item xs={12} sm={6} className={classes.buttonContainer}>
              <ButtonGroup size="medium" variant="outlined">
                ...
                <Button endIcon={<ArrowBack />} sx={{ borderColor: 'primary.main' }}>
                  <Typography style={{ textDecoration: 'none' }} component={Link} to="/" color="inherit" varaiant="subtitle2">
                    Back
                  </Typography>
                </Button>
              </ButtonGroup>
      ...
      <Box marginTop="5rem" width="100%">
        ...
        {recommandations ? <MovieList movies={recommandations} numberOfMovies={10} /> : <Box>Sorry, Nothing was found </Box>}
      </Box>
      <Modal
